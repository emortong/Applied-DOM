...
btn2.addEventListener('click', (e) => {
  setMyLightGreen.apply(e.currentTarget);
})
...
btn7.addEventListener('click', (e) => {
  setMyLightGreen.call(e.currentTarget);
})
...
btn9.addEventListener('click', (event) => {
  setMyLightClass.call(event.currentTarget, event, 'light-green');
})
   ...
   */
const setLight10Green = setMyLightGreen.bind(btn10) // recheck this
...
btn13.addEventListener('click', function(event) {
  setMyLightClass = setMyLightClass.bind(btn13);
